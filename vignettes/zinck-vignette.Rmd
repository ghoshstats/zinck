...
Here is an illustration for a BMI genus level data-set with $n=98$ patients and $p=70$ genera. 
```{r optimal-k,  fig.width=6, fig.height=4}
...
It is clear from the Divergence plot that k=4 is optimal for fitting the zinck model to the BMI genus level data.
